  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center space-x-3">
            ...
            <h1 class="text-lg font-bold text-gray-900 dark:text-white">Agnes AI</h1>
          </div>
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 py-6">
      ...
      <Transition name="slide">
        <ApiConfig v-if="showConfig" />
      </Transition>

      <!-- Connection status -->
      <div v-if="!isConfigured && !showConfig" class="mb-6 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-2">
            <svg class="w-5 h-5 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4.5c-.77-.833-2.694-.833-3.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z" />
            </svg>
            <p class="text-sm text-amber-600 dark:text-amber-400">请先配置 API Key 以使用所有功能</p>
          </div>
          <button
    ...
    <!-- Footer -->
    <footer class="border-t border-gray-200 dark:border-gray-700 py-4 mt-8">
      <p class="text-center text-xs text-gray-400 dark:text-gray-500">
        Powered by Agnes AI API &middot; 使用 Vue 3 + Tailwind CSS 构建
      </p>
    </footer>
  </div>
</template>
